...
export default function RealTimeTable({ initialData, initialUsers }: RealTimeTableProps) {
  ...
  return <TableDatas dataTable={displayData} users={displayUsers} mutate={mutate} />;
} 