...
import { Card, CardHeader, CardBody, Divider, Switch, Chip, Avatar, Input, Button, Modal, addToast } from "@heroui/react";
import { Eye, EyeOff, Image, Mail, MapPin, Phone, Save, User } from "lucide-react";
import { useState, useEffect } from "react";
import { getProfile, updateProfile, updatePhoto } from "../action";
import { useFormState } from "react-dom";
import SaveButton from "../components/SaveButton";
import ChangePhotoModal from "./ChangePhotoModal";

export default function ProfileSetting({ profile, userId }: { profile: any, userId: string }) {
        ...
        <CardBody className="space-y-6">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6 mb-2 flex justify-end">
              <Button color="primary" type="submit" size="sm" startContent={<Save className="w-4 h-4" />}>
                Save Changes
              </Button>
            </div>
          </form>
