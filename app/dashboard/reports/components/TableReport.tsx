...
import { Activity, AlertTriangle, CheckCircle2, Clock, Download, Package, Users, Wrench } from "lucide-react";
...
export default function TableReport({
  ...
  const ErrorState = () => (
    <div className="text-center py-8">
      ...
      <Button color="danger" variant="flat" onPress={onRetry} size="sm">
        Coba Lagi
      </Button>
    </div>
  );
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 min-w-[512px] flex-1">
                <div className={`p-2 rounded-full flex-shrink-0 ${activity.user === "System" ? "bg-secondary-200" : "bg-primary-200"}`}>
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <div className="hidden sm:block">{getActivityIcon(activity.type)}</div>
                <Chip
