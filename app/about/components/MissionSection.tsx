...
import { CheckCircle, Lightbulb, Users, Building2, ShieldCheck } from "lucide-react";
...
export default function MissionSection({ fadeIn, staggerContainer }: MissionSectionProps) {
  return (
    <motion.div 
      className="py-16"
      initial="hidden"
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <motion.div variants={fadeIn}>
          ...
          To become the largest and best company in Indonesia, particularly in the fields of mining and construction, and to serve as a Center of Excellence—growing and enduring over time as one of the nation's most valuable assets.
          </p>
          <Button 
            color="warning" 
            variant="bordered"
