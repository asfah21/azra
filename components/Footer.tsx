  ...
  return (
    <footer className="flex items-center w-full border-t border-default-200 p-5 bg-default-50 justify-center">
      ...
      >
        ...
        <span className="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent font-semibold hover:from-green-600 hover:to-blue-600 transition-all duration-300">Azvan</span>
